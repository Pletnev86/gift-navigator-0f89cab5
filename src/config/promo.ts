...
export const PROMO_CONFIG: PromoConfig = {
  ...
  content: {
    ...
    title: 'Индивидуальная витрина подарков за <span class="text-emerald-500">30 000 ₽</span>',
    subtitle: "Персональная витрина корпоративных подарков под вашу компанию — со скидкой 50%.",
    bullets: [
      "Скидка 50% — цена 30 000 ₽ вместо 60 000 ₽",
      "Расчёт и настройка за 30 минут",
  ...
  analytics: {
    section: "promo_popup",
    buttonLabel: "Получить предложение (промо)",
  },
};
