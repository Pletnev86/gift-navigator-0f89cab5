        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex items-center gap-4">
              ...
              />
              <motion.button
                className="inline-flex items-center gap-2 rounded-xl px-6 py-3 font-heading font-bold text-sm tracking-wide transition-all duration-300 text-foreground"
